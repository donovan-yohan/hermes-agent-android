 ...
 *
 * Desktop registers four kinds (`apps/desktop/src/app/settings/connections-registry.tsx:42-47`
 * @ `72a3277cd7937fd0f0a2a3e3fddbed21d7b1c8bd`). Android ships three: `cloud`
...
data class SavedConnection(
     ...
     * (`apps/desktop/src/lib/connection-display.ts:61-75` @ `72a3277cd7`).
 ...
 * (`connections-registry.tsx:115-134` @ `72a3277cd7`): normalized to
 ...
 * `en.ts:858` @ `72a3277cd7`). Here the person can run more than one
 ...
 *
 * Desktop's rule (`connections-registry.tsx:144-181` @ `72a3277cd7`), minus the
 ...
 * (`connection-display.ts:9-22` @ `72a3277cd7`), Local anchor included now that
 ...
 * `72a3277cd7`). Every whitespace-separated needle must match.
 */
