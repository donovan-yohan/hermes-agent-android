 ...
 * the end of a user turn's text (`tui_gateway/session_history.py` @ `72a3277cd7`,
 ...
 * `extractImageRefs` (`apps/desktop/src/lib/embedded-images.ts` @ `72a3277cd7`)
 * implements. A path containing whitespace arrives quoted with `` ` ``, `"` or
 * `'` (`agent/context_references.py` `format_reference_value` @ `72a3277cd7`).
 */
