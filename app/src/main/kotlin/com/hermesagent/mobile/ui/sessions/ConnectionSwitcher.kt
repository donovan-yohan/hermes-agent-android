 ...
 * (`apps/desktop/src/app/chat/sidebar/connection-switcher.tsx:43-255` @
 ...
 * (`app/shell/hooks/use-statusbar-items.tsx:433,664-668` @ `72a3277cd7`) — and
...
fun ConnectionSwitcherBar(
     ...
     * connections tab (`connection-switcher.tsx:240-242` @ `72a3277cd7`), which
     ...
     * (`connection-switcher.tsx:249,266` @ `72a3277cd7`).
     *
    ...
    Column(modifier) {
        ...
        // handler (`connection-switcher.tsx:131-132` @ `72a3277cd7`,
