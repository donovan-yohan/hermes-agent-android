...
class ComposerReferenceChipsTest {
    ...
    fun testSnapSelection() {
        ...
        var prev = v.copy(selection = TextRange(4))
        var prop = v.copy(selection = TextRange(5))
        var snapped = snapSelectionToReferenceEdges(prev, prop, spans)
        assertEquals(TextRange(32), snapped.selection)
        
        prev = v.copy(selection = TextRange(32))
        prop = v.copy(selection = TextRange(31))
        ...
        prop = v.copy(selection = TextRange(12))
        snapped = snapSelectionToReferenceEdges(prev, prop, spans)
        assertEquals(TextRange(4), snapped.selection)
        
        prop = v.copy(selection = TextRange(28))
        snapped = snapSelectionToReferenceEdges(prev, prop, spans)
        assertEquals(TextRange(32), snapped.selection)
        
        prop = v.copy(selection = TextRange(4))
        snapped = snapSelectionToReferenceEdges(prev, prop, spans)
        assertEquals(TextRange(4), snapped.selection)
        ...
        snapped = snapSelectionToReferenceEdges(v.copy(selection = TextRange(0)), prop, spans)
