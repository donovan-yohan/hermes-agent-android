...
`936b970e281d5d28e930c5698f36bc4ebb54c7ba`, read through
...
node .chalk/skills/port-hermes-desktop-surface/scripts/capture-desktop-reference.mjs \
  ...
  --expect-sha 936b970e281d5d28e930c5698f36bc4ebb54c7ba --match 5174
```

`contract.json` records `upstreamSha:
936b970e281d5d28e930c5698f36bc4ebb54c7ba` and the root node's classes as
