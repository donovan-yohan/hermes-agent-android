...
`29112bef099274229cadff79cdff7bf7b99c4b77`, read through
...
node .chalk/skills/port-hermes-desktop-surface/scripts/capture-desktop-reference.mjs \
  ...
  --expect-sha 29112bef099274229cadff79cdff7bf7b99c4b77 --match 5174
```

`contract.json` records `upstreamSha:
29112bef099274229cadff79cdff7bf7b99c4b77` and the root node's classes as
