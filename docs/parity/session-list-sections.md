...
here rather than disabled, and `docs/workflows/review-desktop-parity.md:244`
...
rather than disabled (#142), the archived view dropping the `Pinned` section
(#146), and the missing row age (#143).
