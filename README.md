...
| Composer and model controls | Rich editor, references, completions, model, effort, and fast mode | **Supported core** — multiline drafts, history/undo, model/provider, effort, fast mode, slash/path/session/emoji completion, and plain-text references |
